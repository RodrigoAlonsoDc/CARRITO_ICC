...
<p class="text-center h3 mt-4">Riesgo Eléctrico</p>
<!-- Demo header-->
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="nav flex-column nav-pills nav-pills-custom" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link mb-3 p-3 shadow" id="v-pills-home-tab" data-toggle="pill" href="#panel2" role="tab" aria-controls="panel2" aria-selected="false">
                        <i class="fa fa-user-circle-o mr-2"></i>
                        <span class="font-weight-bold small text-uppercase">Sesi&oacute;n II</span></a>

                    <a class="nav-link mb-3 p-3 shadow" id="v-pills-profile-tab" data-toggle="pill" href="#panel3" role="tab" aria-controls="panel3" aria-selected="false">
                    ...
                    <a class="nav-link mb-3 p-3 shadow" id="v-pills-messages-tab" data-toggle="pill" href="#panel7" role="tab" aria-controls="panel7" aria-selected="false">
                        <i class="fa fa-star mr-2"></i>
...
<?php 
 ...
 mysqli_set_charset($conexion,"utf8");
			 $sql="SELECT ri.subtitulo1,ri.video1,ri.recurso1 FROM cursos c INNER JOIN riesgo ri ON c.id_riesgo=ri.id_riesgo INNER JOIN usuarios u ON c.id=u.id " ;
...
<a href='cursos/riesgo/$fila[2]' target='_blank'><button type='button' class='btn btn-success'>Descargar Recursos</button></a></p>
...
<div class="tab-pane fade shadow rounded bg-white p-5" id="panel7" role="tabpanel" aria-labelledby="v-pills-profile-tab">
    ...
    $fila=mysqli_fetch_row($result);
     ...
     if ($fila) {
        ...
        echo "  
         ...
         <h4 class='font-italic mb-4'>MÓDULO 7: $fila[0]</h4>
                        <p class='font-italic text-muted mb-2'>
        <div class='embed-responsive embed-responsive-16by9'>
  <iframe class='embed-responsive-item' src='$fila[1]' allowfullscreen></iframe>
</div>  <br><br>
