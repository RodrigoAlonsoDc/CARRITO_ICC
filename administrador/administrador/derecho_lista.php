                ...
                <div class="col-lg-12 card-form__body">
                    ...
                    <div class="table-responsive border-bottom" data-toggle="lists" data-lists-values='["js-lists-values-employee-name"]'>
                        ...
                        <table class="table mb-0 thead-border-top-0">
                            ...
                            $query_list = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM usuario_d WHERE estatus = 1");
                            ...
                            $query = mysqli_query($conection, "SELECT * FROM usuario_d WHERE estatus = 1 ORDER BY iduser_d DESC LIMIT $desde, $por_pagina");
