...
<div class="mdk-drawer-layout__content page">
    ...
    <div class="container-fluid page__heading-container">
        <div class="page__heading d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-lg-between text-center text-lg-left">
            ...
            <a href="ingenieria_registro.php" class="btn btn-success ml-lg-3">Nuevo Curso <i class="material-icons">add</i></a>
        </div>
    </div>
            ...
            <div class="row no-gutters">
                <div class="col-lg-12 card-form__body">
                    ...
                    <div class="table-responsive border-bottom" data-toggle="lists" data-lists-values='["js-lists-values-employee-name"]'>
                        ...
                        <form action="ingenieria_buscar.php" method="GET">
                            <div class="search-form search-form--light m-3">
                                <input type="text" class="form-control search" name="busqueda" id="busqueda" placeholder="Search">
                        ...
                        <table class="table mb-0 thead-border-top-0">
                            ...
                            $query_list = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM usuario WHERE estatus = 1");
                            ...
                            $query = mysqli_query($conection, "SELECT * FROM usuario WHERE estatus = 1 ORDER BY iduser DESC LIMIT $desde, $por_pagina");
                                            ...
                                            <td>
                                                <div class="dropdown ml-auto">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="ingenieria_editar.php?id=<?php echo $data["iduser"]; ?>">Editar</a>
                                                        <?php if ($_SESSION['rol'] == 1) {
                                                            ?>
                                                            <div class="dropdown-divider"></div>
                                                            <a class="dropdown-item text-danger lista__delete" href="ingenieria_delete.php?id=<?php echo $data["iduser"]; ?>">Eliminar</a>
                                                            <?php 
                                                        } ?>
