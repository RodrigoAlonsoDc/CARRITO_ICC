                    ...
                    <div class="course-details__content">
                        ...
                        <div class="courses-one__single style2 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1000ms">
                            <div class="courses-one__single-img">
                                <img src="assets/images/resources/derecho-modificaciones.png" alt=""/>
                            ...
                            <div class="courses-one__single-content">
                                ...
                                <h6 class="courses-one__single-content-name">Mg. Víctor Villanueva <span>Actualizado recientemente 20 junio, 2021</span></h6>
                                <h4 class="courses-one__single-content-title" style="font-family: League Spartan;">Modificaciones al Reglamento con el Estado</h4>
                            ...
                            <ul class="course-details__new-courses-list list-unstyled">
                                <li class="course-details__new-courses-list-item">
                                    <div class="course-details__new-courses-list-item-img">
                                        <img src="assets/images/resources/derecho-penal-icon.png" alt=""/>
                                    </div>
                                    <div class="course-details__new-courses-list-item-content">
                                        <h4 class="course-details__new-courses-list-item-content-title"><a href="derecho_penal.php">Derecho Penal</a></h4>
