<?php  
include 'cursos_derecho/head.php';
include 'cursos_derecho/header.php';
?>
                    ...
                    <div class="course-details__content">
                        ...
                        <div class="courses-one__single style2 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1000ms">
                            <div class="courses-one__single-img">
                                <img src="assets/images/resources/derecho-proceso-desalojo.png" alt=""/>
                            ...
                            <div class="courses-one__single-content">
                                ...
                                <h6 class="courses-one__single-content-name">Dr. Julio Pozo Sánchez <span>Actualizado recientemente 20 junio, 2021</span></h6>
                                <h4 class="courses-one__single-content-title" style="font-family: League Spartan;">Proceso de Desalojo en la Corte Suprema</h4>
                                ...
                                <div class="course-details__content-list">
                                    <h3 class="course-details__curriculum-single-title" style="font-family: League Spartan;">Requisitos</h3>
                                    <ul class="list-unstyled">
                                        <li>
                                            <div class="icon">
                                ...
                                <div class="course-details__content-list">
                                    <h3 class="course-details__curriculum-single-title" style="font-family: League Spartan;">Inversión</h3>
                        ...
                        <div class="course-details__curriculum">
                            <h2 class="course-details__curriculum-title" style="font-family: League Spartan;">Inicio</h2>
                            ...
                            <div class="course-details__curriculum-single">
                                ...
                                <h3 class="course-details__curriculum-single-title" style="font-family: League Spartan;">Pasos para realizar inscripción:</h3>
                                <ol class="">
                                    <li>
                                        <div class="icon">
                                            <span class=""></span>
                        ...
                        <div class="course-details__reviews">
                            <h3 class="course-details__reviews-title" style="font-family: League Spartan;">Reseñas</h3>
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="course-details__sidebar">
                        ...
                        <div class="course-details__new-courses wow fadeInUp animated" data-wow-delay="0.5s">
                            <h3 class="course-details__new-courses-title" style="font-family: League Spartan;">Nuevos cursos</h3>
                            <ul class="course-details__new-courses-list list-unstyled">
                                <li class="course-details__new-courses-list-item">
                                    <div class="course-details__new-courses-list-item-img">
                                        <img src="assets/images/resources/derecho_ambiental-icon.png" alt=""/>
                                    </div>
                                    <div class="course-details__new-courses-list-item-content">
                                        <h4 class="course-details__new-courses-list-item-content-title"><a href="derecho_ambiental.php">Derecho Ambiental</a></h4>
                                ...
                                <li class="course-details__new-courses-list-item">
                                    <div class="course-details__new-courses-list-item-img">
                                        <img src="assets/images/resources/derecho-litigacion-oral-icon.png" alt=""/>
                                    </div>
                                    <div class="course-details__new-courses-list-item-content">
                                        <h4 class="course-details__new-courses-list-item-content-title"><a href="derecho_litigacion_oral.php">Litigación Oral en el nuevo Código Procesal Penal</a></h4>
                                        <div class="course-details__new-courses-rateing-box">
                                            <ul class="list-unstyled">
                                                <li><i class="fas fa-star"></i></li>
                                                <li><i class="fas fa-star"></i></li>
                                ...
                                <li class="course-details__new-courses-list-item">
                                    <div class="course-details__new-courses-list-item-img">
                                        <img src="assets/images/resources/derecho-obra-impuesto-icon.png" alt=""/>
                                    </div>
                                    <div class="course-details__new-courses-list-item-content">
                                        <h4 class="course-details__new-courses-list-item-content-title"><a href="derecho_obra_impuesto.php">Obra por Impuesto</a></h4>
                                        <div class="course-details__new-courses-rateing-box">
                                            <ul class="list-unstyled">
                                                <li><i class="fas fa-star"></i></li>
                                                <li><i class="fas fa-star"></i></li>
    ...
    <!--End Course Details-->
<?php 
include 'cursos_derecho/footer.php';
include 'cursos_derecho/mobile.php';
include 'cursos_derecho/script.php'; 
?>