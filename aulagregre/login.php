...
<div class="container ">
  <div class="row justify-content-md-center align-items-center vh-100" >
    ...
    <div class="col-md-auto  medio">

      <img src="../img/icc1.png" class="img-fluid logo">
      <br>
        <form action="logica/loguear.php" method="POST" >   
      
       <p class="h5 text-start tit">Usuario</p>
       <input type="text" name="usuario" placeholder="usuario" class="form-control input">
       <br>

   

       <p class="h5 text-start tit">Contrase&ntilde;a</p>
       <input type="password"  name="password" placeholder="password" class="form-control input">
       <br>

       <button class="boton" type="submit"> Ingresar a Plataforma</button>
