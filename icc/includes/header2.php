  ...
  <!doctype html>
    ...
    <head>
      ...
      <div class="toggle hidden w-full md:w-auto md:flex text-right text-bold mt-5 md:mt-0 border-t-2 border-blue-900 md:border-none">        
        ...
        <a  href="../index.php" class=" block md:inline-block text-sm px-4 py-2 leading-none rounded text-white border-white hover:border-transparent hover:text-indigo-500 hover:bg-white mt-4 md:mt-0 ">Mis Cursos</a> 
        ...
        <a href="../login.php" class="  block md:inline-block text-sm px-4 py-2 leading-none rounded text-white border-white hover:border-transparent hover:text-indigo-500 hover:bg-white mt-4 md:mt-0 lg:hidden">Cerrar Sesi¨®n</a>
      ...
      $sql="SELECT u.nombre FROM cursos c INNER JOIN usuarios u on c.id=u.id where u.nombre='$usuario' " ;
      ...
      if ($fila) {
        ...
        <a href='#' class='  block md:inline-block text-sm px-6 py-6 leading-none rounded text-white border-white hover:border-transparent hover:text-indigo-500 mt-4 md:mt-0 mr-'>Hola $fila[0]</a>
      ...
      ?>
        ...
        <div class="container mx-auto px-4 flex items-center justify-between py-4">
          ...
          <li>
             ...
             <a href="../login.php" class="flex items-center px-3 py-3 hover:bg-gray-200">
