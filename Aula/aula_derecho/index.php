...
if (!empty($_SESSION['active'])) {
    ...
    if (!empty($_POST)) {
        if (empty($_POST['usuario']) || empty($_POST['clave'])) {
            ...
            $query = mysqli_query($conection, "SELECT * FROM usuario_d WHERE usuario = '$user' AND password = '$pass' ");
        ...
        <div class="card card-body" style="background-color: #1f202ad9;">
            ...
            <form action="" novalidate method="POST">
                ...
                <div class="form-group">
                    <center>
                        <img width="200" src="aula/assets/images/favicons/icc-logo-derecho.png" alt="ICC">
                    </center>
