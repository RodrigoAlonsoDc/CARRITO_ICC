...
?>
        ...
        <div class="mdk-header-layout__content page" >
                ...
                <div class="row" style="height: auto;">
                    <div class="col-md-12">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 mb-4" style="max-height:auto; background: #000;">
                            <iframe id="player1" class="embed-responsive-item" src="https://www.youtube.com/embed/KN4D3V5CNRo" allowfullscreen=""></iframe>
                        </div>
                            ...
                            <div class="card clear-shadow border">
                                <div class="card-body ">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <strong>Modificación al reglamento de la ley de contratación con el estado </strong>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid1" onclick="changeVid(this.id)">Modificaciones al Reglamento de la ley de Contrataciones con el Estado Parte I</a>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid2" onclick="changeVid(this.id)">Modificaciones al Reglamento de la ley de Contrataciones con el Estado Parte II</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid3" onclick="changeVid(this.id)">Modificaciones al Reglamento de la ley de Contrataciones con el Estado Parte III</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
            ...
            <script type="text/javascript">
                ...
                {   
                    var newVid = "https://www.youtube.com/embed/KN4D3V5CNRo";
                    if (clicked_id === 'vid1') {
                        newVid = 'https://www.youtube.com/embed/KN4D3V5CNRo';
                    }
                    if (clicked_id === 'vid2') {
                        newVid = 'https://www.youtube.com/embed/I0FSRNsN3Aw';
                    }
                    if (clicked_id === 'vid3') {
                        newVid = 'https://www.youtube.com/embed/18AF9w0W7cs';
                    }
                    if (clicked_id === 'vid4') {
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="comments">
                                    <div class="tab-pane active" id="overview"><br>
                                        ...
                                        <!--<div class="card-body" id="course_content">
                                            <a href='https://drive.google.com/uc?export=download&id=1AXmHhLUz2_ZzD5UL7LbPLV5NQH3wDr1a' target='_blank'><button type='button' class='btn btn-success'>Modulo 1-ANALIZADOR-DE-REDES-ELECTRICAS-1</button></a>
                                        </div>-->
                                    </div>
                                </div>
