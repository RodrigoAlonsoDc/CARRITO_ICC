...
?>
        ...
        <div class="mdk-header-layout__content page" >
                ...
                <div class="row" style="height: auto;">
                    <div class="col-md-12">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 mb-4" style="max-height:auto; background: #000;">
                            <iframe id="player1" class="embed-responsive-item" src="https://www.youtube.com/embed/MW4-K7pz0vo" allowfullscreen=""></iframe>
                        </div>
                            ...
                            <div class="card clear-shadow border">
                                <div class="card-body ">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <strong>Especialización nuevo codigo procesal penal </strong>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid1" onclick="changeVid(this.id)">El Nuevo Código Procesal, Estructura y Sujetos Procesale</a>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid2" onclick="changeVid(this.id)">La Etapa de Investigación Preparatoria</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid3" onclick="changeVid(this.id)">La Etapa Intermedia: Control de Acusación.</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid4" onclick="changeVid(this.id)">La Etapa de Investigación Preparatoria y La Prueba en el NCPP</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid5" onclick="changeVid(this.id)">La Teoría del Caso</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid6" onclick="changeVid(this.id)">La Utilización de Estrategias de Persuasión en la Etapa de Juicio Oral</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid7" onclick="changeVid(this.id)">Técnicas para Interrogar a un Testigo y y El Alegato de Apertura y Clausura</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid8" onclick="changeVid(this.id)">Taller de Simulación de Audiencias en Juicio Oral y Argumentación</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
            ...
            <script type="text/javascript">
                ...
                {   
                    var newVid = "https://www.youtube.com/embed/MW4-K7pz0vo";
                    if (clicked_id === 'vid1') {
                        newVid = 'https://www.youtube.com/embed/MW4-K7pz0vo';
                    }
                    if (clicked_id === 'vid2') {
                        newVid = 'https://www.youtube.com/embed/WCzQ_tJ3FNQ';
                    }
                    if (clicked_id === 'vid3') {
                        newVid = 'https://www.youtube.com/embed/COQBOvSj2vk';
                    }
                    if (clicked_id === 'vid4') {
                        newVid = 'https://www.youtube.com/embed/h6WNbz5T91s';
                    }
                    if (clicked_id === 'vid5') {
                        newVid = 'https://www.youtube.com/embed/3yOR8fLl9tQ';
                    }
                    if (clicked_id === 'vid6') {
                        newVid = 'https://www.youtube.com/embed/z84y7m4lQrc';
                    }
                    if (clicked_id === 'vid7') {
                        newVid = 'https://www.youtube.com/embed/NfSOV1u9Beo';
                    }
                    if (clicked_id === 'vid8') {
                        newVid = 'https://www.youtube.com/embed/Nj_KszbV1Bo';
                    }
                    if (clicked_id === 'vid9') {
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="comments">
                                    <div class="tab-pane active" id="overview"><br>
                                        ...
                                        <!--<div class="card-body" id="course_content">
                                            <a href='https://drive.google.com/uc?export=download&id=1y3Ud1FIl5elbHSwllW6-PjMjawzUYMQL' target='_blank'><button type='button' class='btn btn-success'>LOS-MODELOS-PROCESALES</button></a>
                                        </div>-->
                                    </div>
                                </div>
