...
?>
        ...
        <div class="mdk-header-layout__content page" >
                ...
                <div class="row" style="height: auto;">
                    <div class="col-md-12">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 mb-4" style="max-height:auto; background: #000;">
                            <iframe id="player1" class="embed-responsive-item" src="https://www.youtube.com/embed/i-XvaG-GjE8" allowfullscreen=""></iframe>
                        </div>
                            ...
                            <div class="card clear-shadow border">
                                <div class="card-body ">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <strong>Redes de Distribución de energía eléctrica </strong>
                                  ...
                                  <div class="">
                                    <div class="tabs">
                                        <div class="tab">
                                            ...
                                            <label class="tab-label" style="width: 100%; margin-bottom: 1px;" for="chck1">Módulo 1: Redes de Distribución de Energía Eléctrica</label>
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid1" onclick="changeVid(this.id)">Según su tensión Nominal</a>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <label class="tab-label" style="width: 100%; margin-bottom: 1px;" for="chck2">Módulo 2: Diseño de Redes Aéreas</label>
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1.</div>
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid2" onclick="changeVid(this.id)">Teoría de cálculo eléctrico</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid3" onclick="changeVid(this.id)">Calculo mecánico de conductores</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid4" onclick="changeVid(this.id)">Criterios generales de diseño</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <label class="tab-label" style="width: 100%; margin-bottom: 1px;" for="chck3">Módulo 3: Diseño de Redes Subterráneas</label>
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1.</div>
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid5" onclick="changeVid(this.id)">Teoría de cálculo eléctrico</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid6" onclick="changeVid(this.id)">Calculo mecánico de conductores</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
            ...
            <script type="text/javascript">
                ...
                {   
                    var newVid = "https://www.youtube.com/embed/i-XvaG-GjE8";
                    if (clicked_id === 'vid1') {
                        newVid = 'https://www.youtube.com/embed/i-XvaG-GjE8';
                    }
                    // SESION 2
                    if (clicked_id === 'vid2') {
                        newVid = 'https://www.youtube.com/embed/FrQ0psRAom8';
                    }
                    if (clicked_id === 'vid3') {
                        newVid = 'https://www.youtube.com/embed/4UV2AIweGkg';
                    }
                    if (clicked_id === 'vid4') {
                        newVid = 'https://www.youtube.com/embed/hVW_LirvT8k';
                    }
                    // SESION 3
                    if (clicked_id === 'vid5') {
                        newVid = 'https://www.youtube.com/embed/pW2OI9T7-vI';
                    }
                    if (clicked_id === 'vid6') {
                        newVid = 'https://www.youtube.com/embed/Nd0cd-pQmpk';
                    }
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="overview">
                                    <div class="card-body" id="course_content">
                                        <h4>OBJETIVO</h4>
                                        <p>Establecer los criterios, métodos, equipos y materiales utilizados en el planeamiento del diseño y construcción de redes de distribución eléctrica subterráneas en media y baja tensión.<p/>
                                        <!--<ul>-->
                                        <!--    <li class="chevron"></li>-->
                                        <!--    <li class="chevron"></li>-->
                                        <!--    <li class="chevron"></li>-->
                                        ...
                                        <p>Con el presente curso se pretende aportar los conocimientos necesarios para gestionar y
diseñar las redes eléctricas aéreas y subterráneas de baja y media tensión, así como los
centros de transformación de interior a partir de un proyecto, de acuerdo con las normas
establecidas y la calidad prevista, garantizando la seguridad integral y las condiciones
óptimas de funcionamiento y conservación medioambiental.<p/>
                                        <!--<ul>-->
                                        <!--    <li class="confirm"></li>-->
                                        <!--    <li class="confirm"></li>-->
                                        <!--    <li class="confirm"></li>-->
                                        ...
                                        <!--    <li class="confirm"></li>-->
                                        <!--</ul>-->
                                        <h4>Módulo I: Redes de Distribución de Energía Eléctrica</h4>
                                        <ul>
                                            <li class="chevron">Según su tensión Nominal.</li>
                                            <li class="chevron">Según su tipo de construcción.</li>
                                            <li class="chevron">Según el tipo de usuarios finales.</li>
                                        </ul>
                                        <h4>Módulo II: 	Diseño de Redes Aéreas</h4>
                                        <ul>
                                            <li class="chevron">Teoría de cálculo eléctrico.</li>
                                            <li class="chevron">Calculo mecánico de conductores.</li>
                                            <li class="chevron">Criterios generales de diseño.</li>
                                        </ul>
                                        <h4>Módulo III: Diseño de Redes Subterráneas </h4>
                                        <ul>
                                            <li class="chevron">Teoría de cálculo eléctrico</li>
                                            <li class="chevron">Calculo mecánico de conductores</li>
                                            <li class="chevron">Criterios generales de diseño</li>
                                        </ul>
                                        <h4>Módulo IV: Diseño de Centros de Transformación Tipo Poste</h4>
                                        <ul>
                                            <li class="chevron">Selección del fusible de media tensión.</li>
                                            <li class="chevron">Selección de calibre del bajante en media tensión.</li>
                                            <li class="chevron">Cálculo de la potencia del transformador.</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane" id="comments">
                                    <div class="tab-pane active" id="overview"><br>
                                        ...
                                        <div class="card-body" id="course_content">
                                            ...
                                            <a href='https://drive.google.com/drive/folders/1wqpwglaaJss9SVWnRScUhHhRhthnOSrL?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
