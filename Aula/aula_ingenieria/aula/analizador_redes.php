...
?>
        ...
        <div class="mdk-header-layout__content page" >
                ...
                <div class="row" style="height: auto;">
                    <div class="col-md-12">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 mb-4" style="max-height:auto; background: #000;">
                            <iframe id="player1" class="embed-responsive-item" src="https://www.youtube.com/embed/ND9JPJyX3Fw" allowfullscreen=""></iframe>
                        </div>
                            ...
                            <div class="card clear-shadow border">
                                <div class="card-body ">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <strong>Configuración e instalación de analizadores de redes </strong>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid1" onclick="changeVid(this.id)">Video I : Analizador de Redes</a>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid2" onclick="changeVid(this.id)">Video II : Analizador de Redes</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid3" onclick="changeVid(this.id)">Video III : Analizador de Redes</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
            ...
            <script type="text/javascript">
                ...
                {   
                    var newVid = "https://www.youtube.com/embed/ND9JPJyX3Fw";
                    if (clicked_id === 'vid1') {
                        newVid = 'https://www.youtube.com/embed/ND9JPJyX3Fw';
                    }
                    if (clicked_id === 'vid2') {
                        newVid = 'https://www.youtube.com/embed/Kwykg849Ayg';
                    }
                    if (clicked_id === 'vid3') {
                        newVid = 'https://www.youtube.com/embed/WZceKrrsnGg';
                    }
                    if (clicked_id === 'vid4') {
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="overview">
                                    <div class="card-body" id="course_content">
                                        <h4>Dirigido a</h4>
                                        <p>El curso tiene la finalidad de proporcionar los conocimientos necesarios para que los participantes tengan la capacidad de seleccionar,
instalar, configurar analizadores en las redes
eléctricas y obtener registros de parámetros
eléctricos y perturbaciones.<p/>
                                        <!--<ul>-->
                                        <!--    <li class="chevron"></li>-->
                                        <!--    <li class="chevron"></li>-->
                                        <!--    <li class="chevron"></li>-->
                                        ...
                                        <p>El curso está desarrollado por especialistas en
sistemas eléctricos con conocimientos de calidad
de energía, normativa nacional y experiencia en
mediciones eléctricas.<p/>
                                        <p>Como parte del aprendizaje el participante tendrá
acceso a información teórica y práctica,
adquiriendo así conocimientos que puedan
potenciar sus habilidades en mediciones eléctricas
de sistemas en baja y media tensión.
El curso está dirigido a ingenieros, supervisores y

técnicos que requieran especializarse en calidad
de energía eléctrica.<p/>
                                        ...
                                        <!--    <li class="confirm"></li>-->
                                        <!--</ul>-->
                                        <h4>MÓDULO 1: generalidades</h4>
                                        <ul>
                                            <li class="chevron">Tipos de analizadores</li>
                                            <li class="chevron">Homologación - INACAL</li>
                                            <li class="chevron">Normativa Vigente</li>
                                        </ul>
                                        <h4>MÓDULO 2: mediciones y perturbaciones</h4>
                                        <ul>
                                            <li class="chevron">Parámetros eléctricos</li>
                                            <li class="chevron">Perturbaciones eléctricas</li>
                                        </ul>
                                        <h4>MÓDULO 3: selección</h4>
                                        <ul>
                                            <li class="chevron">Por el Rango de medición</li>
                                            <li class="chevron">Por los componentes</li>
                                            <li class="chevron">Por disposición de uso</li>
                                            <li class="chevron">Por su nivel de precisión</li>
                                        </ul>
                                        ...
                                        <h4>MÓDULO 7: taller</h4>
                                        <ul>
                                            <li class="chevron">Instalación de analizador de redes My Ebox 1500 – Circutor</li>
                                            <li class="chevron">Conexionado del equipo en interruptor principal.</li>
                                            <li class="chevron">Configuración eventos y parámetros eléctricos.</li>
                                            <li class="chevron">Selección del tipo de conexión</li>
                                            <li class="chevron">Programación de intervalos de medición</li>
                                            <li class="chevron">Extracción de información del equipo</li>
                                            <li class="chevron">Modelación de datos</li>
                                            <li class="chevron">Elaboración de informe técnico</li>
                                        </ul>
                                        <h4>MÓDULO 8: evaluación</h4>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane" id="comments">
                                    <div class="tab-pane active" id="overview"><br>
                                        ...
                                        <div class="card-body" id="course_content">
                                            <strong>Modelo de Informe de Analizador de Redes </strong><br>
                                            <a href='https://drive.google.com/file/d/1v4YWbvrwKL1HhdCh1K4KI-uOIa_F7VWY/view?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                            
                                            <strong>Material de Trabajo Analizador de Redes </strong><br>
                                            <a href='https://drive.google.com/file/d/1JubAvmudYD0OwQ5zj3gizmMxAzvMrTaW/view?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                        </div>
                                    </div>
                                </div>
