                            ...
                            <div class="card clear-shadow border">
                                <div class="card-body ">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <strong>Costos y presupuestos para proyectos eléctricos </strong>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid1" onclick="changeVid(this.id)">Costo y presupuesto</a>
                                                    </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="overview">
                                    <div class="card-body" id="course_content">
                                        <h4>OBJETIVO</h4>
                                        <p>El curso tiene la finalidad de proporcionar los
conocimientos necesarios para que los participantes
tengan la capacidad de analizar los distintos costos que
involucran la ejecución de un proyecto del sector
eléctrico, elaborar propuestas técnicas económicas y
evaluar financieramente un proyectos.<p/>
                                        <!--<ul>-->
                                        <!--    <li class="chevron"></li>-->
                                        <!--    <li class="chevron"></li>-->
                                        <!--    <li class="chevron"></li>-->
                                        ...
                                        <p>El curso está desarrollado por un especialista con
conocimientos en costos, presupuestos y ejecución de
proyectos eléctricos de pequeña y mediana
envergadura.<p/>
                                        <p>Como parte del aprendizaje el participante tendrá
acceso a información teórica y práctica, adquiriendo así
conocimientos que puedan potenciar sus habilidades
para la evaluación de costos, elaboración de propuestas
técnicas económicas y evaluación financiera del
proyecto.<p/>                           
                                        <p>El curso está dirigido a ingenieros, supervisores y
técnicos relacionados a la elaboración de cotizaciones,
evaluadores de costos y gestores de proyectos.</p>
                                        <!--<ul>-->
                                        <!--    <li class="confirm"></li>-->
                                        <!--    <li class="confirm"></li>-->
                                        <!--    <li class="confirm"></li>-->
                                        ...
                                        <!--    <li class="confirm"></li>-->
                                        <!--</ul>-->
                                        <h4>MÓDULO I: Costos y Gastos</h4>
                                        <ul>
                                            <li class="chevron">Introducción y generalidades de los costos</li>
                                            <li class="chevron">Características de los costos</li>
                                            <li class="chevron">Definición de costos indirectos</li>
                                            <li class="chevron">Definición de costos directos</li>
                                        </ul>
                                        <h4>MÓDULO II: Costos Indirectos</h4>
                                        <ul>
                                            <li class="chevron">Costos indirectos de operación</li>
                                            <li class="chevron">Costos indirectos de obra</li>
                                            <li class="chevron">Financiamiento</li>
                                            <li class="chevron">Factoring</li>
                                            <li class="chevron">Definición de Gastos Generales</li>
                                            <li class="chevron">Utilidad</li>
                                        </ul>
                                        <h4>MÓDULO III: Costos Directos</h4>
                                        <ul>
                                            <li class="chevron">Materiales</li>
                                            <li class="chevron">Especificaciones</li>
                                            <li class="chevron">Investigación de mercado de materiales.</li>
                                            <li class="chevron">Costo directo básico de materiales.</li>
                                            <li class="chevron">Mano de obra</li>
                                            <li class="chevron">Costo unitario de trabajo.</li>
                                            <li class="chevron">Salario diario total.</li>
                                            <li class="chevron">Factor del salario real</li>
                                            <li class="chevron">Costo directo real de mano de Obra</li>
                                            <li class="chevron">Integración de grupos de trabajo</li>
                                            <li class="chevron">Equipos y herramientas</li>
                                            <li class="chevron">Definición de equipos y herramientas.</li>
                                            <li class="chevron">Evaluaci ón del mercado.</li>
                                            <li class="chevron">Definición de equipamiento en Horas máquina.</li>
                                        </ul>
                                        <h4>MÓDULO 4: instalación</h4>
                                        <ul>
                                            <li class="chevron">Consideraciones de instalación</li>
                                            <li class="chevron">Conexionado del equipo</li>
                                            <li class="chevron">Instalación en Puerta de panel</li>
                                            <li class="chevron">Instalación en campo</li>
                                        </ul>
                                        <h4>MÓDULO 5: configuración</h4>
                                        <ul>
                                            <li class="chevron">Configuración eventos y parámetros eléctricos</li>
                                            <li class="chevron">Selección del tipo de conexión</li>
                                            <li class="chevron">Programación de intervalos de medición</li>
                                        </ul>
                                        <h4>MÓDULO 6: registro de información</h4>
                                        <ul>
                                            <li class="chevron">Extracción de información del equipo</li>
                                            <li class="chevron">Modelación de datos</li>
                                        </ul>
                                        <h4>MÓDULO IV: Análisis de Precios Unitarios</h4>
                                        <ul>
                                            <li class="chevron">Integración de precios unitarios</li>
                                            <li class="chevron">Costos directos: Materiales, Mano de obra, Equipo</li>
                                            <li class="chevron">Costos Indirectos: de operación, de campo, financiamiento, utilidad, adicionales.</li>
                                        </ul>
                                        <h4>MÓDULO V: Elaboración de propuestas técnicas económicas.</h4>
                                        <ul>
                                            <li class="chevron">Propuesta técnica</li>
                                            <li class="chevron">Propuesta económica</li>
                                            <li class="chevron">Condiciones comerciales</li>
                                        </ul>
                                        <h4>RESUMEN DE PRÁCTICAS:</h4>
                                        <ul>
                                            <li class="chevron">Presentación de CASO PRÁCTICO: Instalación de subestación eléctrica de 150KVA.</li>
                                            <li class="chevron">Determinar Costos y gastos del proyecto.</li>
                                            <li class="chevron">Elaboración de APU.</li>
                                            <li class="chevron">Elaboración de propuesta técnica económica.</li>
                                            <li class="chevron">Evaluación financiera del proyecto</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane" id="comments">
                                    <div class="tab-pane active" id="overview"><br>
                                        ...
                                        <div class="card-body" id="course_content">
                                            <strong>Modelo de Presupuesto para Proyectos </strong><br>
                                            <a href='https://drive.google.com/file/d/10OXymAF55PGfeZrb4WteENMq75-5geyG/view?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                            
                                            <strong>Modelo de Presupuesto para Proyectos </strong><br>
                                            <a href='https://docs.google.com/spreadsheets/d/17IIjftvQtVezq9SWyMkfq0jsoaXb2Td9/edit?usp=sharing&ouid=118353300478695509395&rtpof=true&sd=true' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                            
                                            <strong>Presentacion Costos y Presupuestos </strong><br>
                                            <a href='https://drive.google.com/file/d/1_rldzKyHC_pMQsyOJ2OV3dBjw7w9UcuP/view?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                            
                                            <strong>Presentacion Costos y Presupuestos </strong><br>
                                            <a href='https://docs.google.com/presentation/d/1mhevDIn0qfePPakJ6cDwmfHcnC79_SRG/edit?usp=sharing&ouid=118353300478695509395&rtpof=true&sd=true' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                        </div>
                                    </div>
                                </div>
