...
?>
        ...
        <div class="mdk-header-layout__content page">
                ...
                <div class="row" style="height: auto;">
                    <div class="col-md-12">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 mb-4" style="max-height:auto; background: #000;">
                            <iframe id="player1" class="embed-responsive-item" src="https://www.youtube.com/embed/ceAzY2SfUCo" allowfullscreen=""></iframe>
                        </div>
                            ...
                            <div class="card clear-shadow border">
                                <div class="card-body ">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <strong>Medición de aislamiento en baja y media tensión </strong>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid1" onclick="changeVid(this.id)">Medición de aislamiento en baja y media tensión.</a>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid2" onclick="changeVid(this.id)">Comparación de resultados.</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
            ...
            <script type="text/javascript">
                ...
                {   
                    var newVid = "https://www.youtube.com/embed/ceAzY2SfUCo";
                    if (clicked_id === 'vid1') {
                        newVid = 'https://www.youtube.com/embed/ceAzY2SfUCo';
                    }
                    if (clicked_id === 'vid2') {
                        newVid = 'https://www.youtube.com/embed/_ap-Yu_ZfhY';
                    }
                    if (clicked_id === 'vid3') {
...
óptimas de funcionamiento y conservación medioambiental.<p/>
                                        ...
                                        <h4>Módulo I:</h4>
                                        <ul>
                                            <li class="chevron">Medición de aislamiento en baja y media tensión.</li>
                                        </ul>
                                        <h4>Módulo II:</h4>
                                        <ul>
                                            <li class="chevron">Comparación de resultados.</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane" id="comments">
                                    <div class="tab-pane active" id="overview"><br>
                                        ...
                                        <div class="card-body" id="course_content">
                                            ...
                                            <a href='https://drive.google.com/drive/folders/18FlCVfgH1QQQssE0Fh5-M4swd9dXII4-?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                            
                                            <strong>MEDICION DE AISLAMIENTO EN BAJA Y MEDIA TENSION ICC </strong><br>
                                            <a href='https://docs.google.com/presentation/d/12qOXeadmMVZWRItFRvdAzzEN1-dJrwqD/edit?usp=share_link&ouid=109538134094239867146&rtpof=true&sd=true' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                            
                                            <strong>Medidas eléctricas reglamentarias en media tension </strong><br>
                                            <a href='https://drive.google.com/file/d/1cwE7uhfYWwm-P2w9lofH6aaUXpbthay3/view?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
