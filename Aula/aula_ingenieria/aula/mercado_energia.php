...
?>
        ...
        <div class="mdk-header-layout__content page" >
                ...
                <div class="row" style="height: auto;">
                    <div class="col-md-12">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 mb-4" style="max-height:auto; background: #000;">
                            <iframe id="player1" class="embed-responsive-item" src="https://www.youtube.com/embed/N00lTaBzE3I" allowfullscreen=""></iframe>
                        </div>
                            ...
                            <div class="card clear-shadow border">
                                <div class="card-body ">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <strong>Regulación del mercado de energía </strong>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid1" onclick="changeVid(this.id)">Sesión I Vídeo: Característicos y Estructura de Sector de Energía/Marco interinstitucional del Subsector Eléctrico/Títulos habilitantes en el Subsector Eléctrico</a>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid2" onclick="changeVid(this.id)">Sesión II: Supervisión del OEFA en el subsector eléctrico</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                    ...
                    <div class="col-md-6">
                        <div data-perfect-scrollbar style="position: relative; height:auto;">
                            <div class="card clear-shadow border">
                                <div class="card-body ">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <strong>Regulación del mercado de energía de hidrocarburos líquidos </strong>
                                        <small class="text-muted">3h 25min</small>
                                    </div>
                                    <div>
                                        <span class="mr-2">
                                  ...
                                  <div class="">
                                    <div class="tabs">
                                        <div class="tab">
                                            ...
                                            <label class="tab-label" style="width: 100%; margin-bottom: 1px;" for="chck3">Módulo 1</label>
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1.</div>
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid3" onclick="changeVid(this.id)">Sesión I: Los Hidrocarburos Parte 1</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <label class="tab-label" style="width: 100%; margin-bottom: 1px;" for="chck4">Módulo 2</label>
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1.</div>
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid4" onclick="changeVid(this.id)">Sesión II: Los Hidrocarburos Parte 2</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <label class="tab-label" style="width: 100%; margin-bottom: 1px;" for="chck5">Módulo 3</label>
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1.</div>
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid5" onclick="changeVid(this.id)">Sesión III: Hidrocarburos (Comercialización y almacenamiento)</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <label class="tab-label" style="width: 100%; margin-bottom: 1px;" for="chck6">Módulo 4</label>
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1.</div>
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid6" onclick="changeVid(this.id)">Sesión IV: Regulación del mercado de Hidrocarburos Líquidos/Aspectos Ambientales/Institucionalidad</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
            ...
            <script type="text/javascript">
                ...
                {   
                    var newVid = "https://www.youtube.com/embed/N00lTaBzE3I";
                    if (clicked_id === 'vid1') {
                        newVid = 'https://www.youtube.com/embed/N00lTaBzE3I';
                    }
                    if (clicked_id === 'vid2') {
                        newVid = 'https://www.youtube.com/embed/jUuVZt1TDYQ';
                    }
                    if (clicked_id === 'vid3') {
                        newVid = 'https://www.youtube.com/embed/TfsrohfGHrA';
                    }
                    if (clicked_id === 'vid4') {
                        newVid = 'https://www.youtube.com/embed/8I8dPp3WcvQ';
                    }
                    if (clicked_id === 'vid5') {
                        newVid = 'https://www.youtube.com/embed/KXAeCyPO0yM';
                    }
                    if (clicked_id === 'vid6') {
                        newVid = 'https://www.youtube.com/embed/R_rv00SkaZk';
                    }
                    if (clicked_id === 'vid7') {
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="comments">
                                    <div class="tab-pane active" id="overview"><br>
                                        ...
                                        <div class="card-body" id="course_content">
                                            <a href='https://drive.google.com/uc?export=download&id=1MKE6Q9x3q_PZFsWk1F4TkIFmczTYEQQc' target='_blank'><button type='button' class='btn btn-success'>Juan-Ortiz-Guevara-1</button></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane active" id="overview">
                                        <div class="card-body" id="course_content">
                                            <a href='https://drive.google.com/uc?export=download&id=1Kb357CgVaYs9YhmcB8ixxE7eVVK3W-dw' target='_blank'><button type='button' class='btn btn-success'>Juan-Ortiz-Guevara-2</button></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane active" id="overview">
                                        <div class="card-body" id="course_content">
                                            <a href='https://drive.google.com/uc?export=download&id=1pcRIIPN2vfHwLm99PYRWWezf9JyjCvWk' target='_blank'><button type='button' class='btn btn-success'>Fransciso-Torres-Madrid</button></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane active" id="overview">
                                        <div class="card-body" id="course_content">
                                            <a href='https://drive.google.com/uc?export=download&id=1DTDDA4IKpbI84RU-xKneHC-YuuMY6Iy6' target='_blank'><button type='button' class='btn btn-success'>DELIA-MORALES-CUTI</button></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane active" id="overview">
                                        <div class="card-body" id="course_content">
                                            <a href='https://drive.google.com/uc?export=download&id=1CL3txZd6TXWrCuQhg-x_ZLAQ0f75RA6o' target='_blank'><button type='button' class='btn btn-success'>Comercializacion-y-Almacenamiento-de-Hidro-EGARCIA</button></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane active" id="overview">
                                        <div class="card-body" id="course_content">
                                            <a href='https://drive.google.com/uc?export=download&id=1HvVO23e5_mJBr7FizHfoYAGXg7DXkuTN' target='_blank'><button type='button' class='btn btn-success'>ALCIDES-CLAROS-PACHECO-1</button></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane active" id="overview">
                                        <div class="card-body" id="course_content">
                                            <a href='https://drive.google.com/uc?export=download&id=1O_V30uungNggSIF7EcEuBmYoyG-oyeDl' target='_blank'><button type='button' class='btn btn-success'>ALCIDES-CLAROS-PACHECO-2</button></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane active" id="overview">
                                        <div class="card-body" id="course_content">
                                            <a href='https://drive.google.com/uc?export=download&id=1INFUwywIkdqM5ww2z25J_Z8dipBzTXMy' target='_blank'><button type='button' class='btn btn-success'>ALCIDES-CLAROS-PACHECO-3</button></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane active" id="overview">
                                        <div class="card-body" id="course_content">
                                            <a href='https://drive.google.com/uc?export=download&id=1cPo8cI3AUaCW507QKzlkUaf4H1TBZzIm' target='_blank'><button type='button' class='btn btn-success'>1-Aspectos-Ambientales-Institucionalidad-VF</button></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane active" id="overview">
                                        <div class="card-body" id="course_content">
                                            <a href='https://drive.google.com/uc?export=download&id=1a3C2-YO44F3VSyB0gzLW9KHnLAVebUrN' target='_blank'><button type='button' class='btn btn-success'>2-Hidrocarburos-071017</button></a>
                                        </div>
                                    </div>
                                </div>
