...
?>
        ...
        <div class="mdk-header-layout__content page" >
                ...
                <div class="row" style="height: auto;">
                    <div class="col-md-12">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 mb-4" style="max-height:auto; background: #000;">
                            <iframe id="player1" class="embed-responsive-item" src="https://www.youtube.com/embed/T53-Cnrqnt0" allowfullscreen=""></iframe>
                        </div>
                            ...
                            <div class="card clear-shadow border">
                                <div class="card-body ">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <strong>Análisis de facturación de tarifas eléctricas </strong>
                                  ...
                                  <div class="">
                                    <div class="tabs">
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid1" onclick="changeVid(this.id)">Video I : Análisis de Facturación y Tarifas Eléctricas</a>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid2" onclick="changeVid(this.id)">Video II : Análisis de Facturación y Tarifas Eléctricas</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid3" onclick="changeVid(this.id)">Video III : Análisis de Facturación y Tarifas Eléctricas</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid4" onclick="changeVid(this.id)">Video IV : Análisis de Facturación y Tarifas Eléctricas</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid5" onclick="changeVid(this.id)">Video V : Análisis de Facturación y Tarifas Eléctricas</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid6" onclick="changeVid(this.id)">Video VI : Análisis de Facturación y Tarifas Eléctricas</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid7" onclick="changeVid(this.id)">Video VII : Análisis de Facturación y Tarifas Eléctricas</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <label class="tab-label" style="width: 100%; margin-bottom: 1px;" for="chck3">Módulo 3 PARTE PRACTICA</label>
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1.</div>
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid8" onclick="changeVid(this.id)">Sesión 1: Datos del suministro e histograma.</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid9" onclick="changeVid(this.id)">Sesión 2: Consumo de energía y demanda.</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid10" onclick="changeVid(this.id)">Sesión 3: Consumo de energía reactiva.</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid11" onclick="changeVid(this.id)">Sesión 4: Identificación de costos.</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid12" onclick="changeVid(this.id)">Sesión 5: Puntos de ahorro en la factura.</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <label class="tab-label" style="width: 100%; margin-bottom: 1px;" for="chck4">Módulo 4 PARTE PRACTICA</label>
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1.</div>
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid13" onclick="changeVid(this.id)">Sesión 1: Consumos facturados</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid14" onclick="changeVid(this.id)">Sesión 2: Calculo de potencia de generación y distribución</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid15" onclick="changeVid(this.id)">Sesión 3: Calculo de factor de calificación
</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid16" onclick="changeVid(this.id)">Sesión 4: Identificación de costos.</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid17" onclick="changeVid(this.id)">Sesión 5: Sumatoria de consumos.</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid18" onclick="changeVid(this.id)">Sesión 6: Evaluación de resultados.</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
            ...
            <script type="text/javascript">
                ...
                {   
                    var newVid = "https://www.youtube.com/embed/T53-Cnrqnt0";
                    if (clicked_id === 'vid1') {
                        newVid = 'https://www.youtube.com/embed/T53-Cnrqnt0';
                    }
                    if (clicked_id === 'vid2') {
                        newVid = 'https://www.youtube.com/embed/2UC3WPrTk20';
                    }
                    if (clicked_id === 'vid3') {
                        newVid = 'https://www.youtube.com/embed/rCpAnnXIsqI';
                    }
                    if (clicked_id === 'vid4') {
                        newVid = 'https://www.youtube.com/embed/gRBZLI0B6Xs';
                    }
                    if (clicked_id === 'vid5') {
                        newVid = 'https://www.youtube.com/embed/7KnU4wd56U0';
                    }
                    if (clicked_id === 'vid6') {
                        newVid = 'https://www.youtube.com/embed/k-Ls_jQNmvs';
                    }
                    if (clicked_id === 'vid7') {
                        newVid = 'https://www.youtube.com/embed/amcs4nUXFMk';
                    }
                    if (clicked_id === 'vid8') {
                        newVid = 'https://www.youtube.com/embed/tlzFxrJpUl0';
                    }
                    if (clicked_id === 'vid9') {
                        newVid = 'https://www.youtube.com/embed/GBaHiL6ZVGY';
                    }
                    if (clicked_id === 'vid10') {
                        newVid = 'https://www.youtube.com/embed/r7xv_KCNENo';
                    }
                    if (clicked_id === 'vid11') {
                        newVid = 'https://www.youtube.com/embed/zi_8GvCtuu4';
                    }
                    if (clicked_id === 'vid12') {
                        newVid = 'https://www.youtube.com/embed/Q5vAmeyWVeQ';
                    }
                    if (clicked_id === 'vid13') {
                        newVid = 'https://www.youtube.com/embed/3sQ__eVe_9Q';
                    }
                    if (clicked_id === 'vid14') {
                        newVid = 'https://www.youtube.com/embed/5KmnsTVRfB4';
                    }
                    if (clicked_id === 'vid15') {
                        newVid = 'https://www.youtube.com/embed/MrJZFnj9ilM';
                    }
                    if (clicked_id === 'vid16') {
                        newVid = 'https://www.youtube.com/embed/1nxVStXoWlQ';
                    }
                    if (clicked_id === 'vid17') {
                        newVid = 'https://www.youtube.com/embed/Mo1RaEcnwI4';
                    }
                    if (clicked_id === 'vid18') {
                        newVid = 'https://www.youtube.com/embed/zqz7u8kqn9I';
                    }
                    if (clicked_id === 'vid19') {
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="overview">
                                    <div class="card-body" id="course_content">
                                        ...
                                        <p>Capacitar a los participantes en análisis y evaluación de opciones tarifarias en media y baja tensión.<p/>
                                        <p>A su vez permite que tengan conocimiento sobre facturas de energía eléctrica y asi puedan asesorar a cualquier usuario sobre los distintos tipos de tarificación a los cuales acogerse.<p/>
                                        <!--<ul>-->
                                        <!--    <li class="chevron"></li>-->
                                        <!--    <li class="chevron"></li>-->
                                        <!--    <li class="chevron"></li>-->
                                        ...
                                        <h4>Dirigido a</h4>
                                        <p>Técnicos, supervisores e ingenieros de la rama de electricidad y público en general, los cuales aprenderán con la teoría y aplicaciones prácticas que se encontrarán en trabajos de campo.<p/>
                                        <!--<ul>-->
                                        <!--    <li class="confirm"></li>-->
                                        <!--    <li class="confirm"></li>-->
                                        <!--    <li class="confirm"></li>-->
                                        ...
                                        <!--    <li class="confirm"></li>-->
                                        <!--</ul>-->
                                        <h4>MODULO 1: teoría</h4>
                                        <ul>
                                            <li class="chevron">Introducción teórica, conceptos básicos</li>
                                            <li class="chevron">Tipos de suministros eléctricos</li>
                                            <li class="chevron">Definiciones de parámetros en la tarifa eléctrica (HP, HFP, potencia contratada, energía activa y reactiva, máxima demanda, etc.)</li>
                                            <li class="chevron">Definición y análisis de opciones tarifarias (BT2, BT3, BT4, MT2, MT3 y MT4)</li>
                                            <li class="chevron">Análisis del pliego tarifario</li>
                                        </ul>
                                        <h4>MODULO 2: práctica, caso real</h4>
                                        <ul>
                                            <li class="chevron">Análisis de facturas eléctricas</li>
                                            <li class="chevron">Aplicación de retorno de inversión</li>
                                            <li class="chevron">Elección tarifaria</li>
                                            <li class="chevron">Definición y análisis de opciones tarifarias (BT2, BT3, BT4, MT2, MT3 y MT4)</li>
                                            <li class="chevron">Elaboración de reporte</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane" id="comments">
                                    <div class="tab-pane active" id="overview"><br>
                                        ...
                                        <div class="card-body" id="course_content">
                                            <strong>Presentación Analisis de facturas y evaluacion de T.E </strong><br>
                                            <a href='https://drive.google.com/file/d/1UbgojypsLW2WbG0oDaJlmz1VpbxTrhDp/view' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                            
                                            <strong>Pliego Tarifario Luz de Sur </strong><br>
                                            <a href='https://drive.google.com/file/d/1bir1RSQfY8QYoxHmcpc7y90U291vy4fP/view?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                            
                                            <strong>Modelo de Tarifas en Baja tension </strong><br>
                                            <a href='https://docs.google.com/spreadsheets/d/14o8l75NK1naY-isvZ5uq00XU_ya8ZtiW/edit?usp=sharing&ouid=118353300478695509395&rtpof=true&sd=true' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                            
                                            <strong>Manual de Regulador de Energia Reactiva </strong><br>
                                            <a href='https://drive.google.com/file/d/13NSwEGh0qFKywHXftNDyQQv6TRK4U7k5/view?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                            
                                            <strong>LIBROS </strong><br>
                                            <a href='https://drive.google.com/drive/folders/1oZNeO3r-1NWnVUBZV3XZMyVCYVDp_iXw?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br>
                                        </div>
                                    </div>
                                </div>
