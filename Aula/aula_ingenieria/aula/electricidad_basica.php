...
?>
        ...
        <div class="mdk-header-layout__content page">
                ...
                <div class="row" style="height: auto;">
                    <div class="col-md-12">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 mb-4" style="max-height:auto; background: #000;">
                            <iframe id="player1" class="embed-responsive-item" src="https://www.youtube.com/embed/XAyrzI-Lsh0" allowfullscreen=""></iframe>
                        </div>
                            ...
                            <div class="card clear-shadow border">
                                <div class="card-body ">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <strong>Electricidad básica </strong>
                                  ...
                                  <div class="">
                                    <div class="tabs">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid1" onclick="changeVid(this.id)">PRINCIPIOS DE ELECTRICIDAD.</a>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid2" onclick="changeVid(this.id)">MAGNETISMO.</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid3" onclick="changeVid(this.id)">INSTRUMENTOS DE MEDICIÓN Y HERRAMIENTAS.</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid4" onclick="changeVid(this.id)">CIRCUITOS CON RESISTENCIA.</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid5" onclick="changeVid(this.id)">ENERGÍA Y POTENCIA.</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid6" onclick="changeVid(this.id)">SIMBOLOGÍA DE LOS CIRCUITOS ELÉCTRICOS.</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <label class="tab-label" style="width: 100%; margin-bottom: 1px;" for="chck7">Módulo 7: Parte Practica I</label>
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1.</div>
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid7" onclick="changeVid(this.id)">PRACTICA I.</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <label class="tab-label" style="width: 100%; margin-bottom: 1px;" for="chck8">Módulo 8: Parte Practica II</label>
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1.</div>
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid7" onclick="changeVid(this.id)">PRACTICA II.</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
            ...
            <script type="text/javascript">
                ...
                {   
                    var newVid = "https://www.youtube.com/embed/XAyrzI-Lsh0";
                    if (clicked_id === 'vid1') {
                        newVid = 'https://www.youtube.com/embed/XAyrzI-Lsh0';
                    }
                    if (clicked_id === 'vid2') {
                        newVid = 'https://www.youtube.com/embed/S5PfGtUJ6Wk';
                    }
                    if (clicked_id === 'vid3') {
                        newVid = 'https://www.youtube.com/embed/aUrOSbWmPCA';
                    }
                    if (clicked_id === 'vid4') {
                        newVid = 'https://www.youtube.com/embed/S82IAoHnQfI';
                    }
                    if (clicked_id === 'vid5') {
                        newVid = 'https://www.youtube.com/embed/bsOcmzgUYGU';
                    }
                    if (clicked_id === 'vid6') {
                        newVid = 'https://www.youtube.com/embed/YbfZXM9JTfg';
                    }
                    if (clicked_id === 'vid7') {
                        newVid = 'https://www.youtube.com/embed/pTTyjrYuRyE';
                    }
                    if (clicked_id === 'vid8') {
                        newVid = 'https://www.youtube.com/embed/4nXxLcPb3Zg';
                    }
                    if (clicked_id === 'vid9') {
...
óptimas de funcionamiento y conservación medioambiental.<p/>
                                        ...
                                        <h4>Módulo I:</h4>
                                        <ul>
                                            <li class="chevron">PRINCIPIOS DE ELECTRICIDAD.</li>
                                        </ul>
                                        <h4>Módulo II:</h4>
                                        <ul>
                                            <li class="chevron">MAGNETISMO.</li>
                                        </ul>
                                        <h4>Módulo III:</h4>
                                        <ul>
                                            <li class="chevron">INSTRUMENTOS DE MEDICIÓN Y HERRAMIENTAS.</li>
                                        </ul>
                                        <h4>Módulo IV:</h4>
                                        <ul>
                                            <li class="chevron">CIRCUITOS CON RESISTENCIA.</li>
                                        </ul>
                                        <h4>Módulo V:</h4>
                                        <ul>
                                            <li class="chevron">ENERGÍA Y POTENCIA.</li>
                                        </ul>
                                        <h4>Módulo VI:</h4>
                                        <ul>
                                            <li class="chevron">SIMBOLOGÍA DE LOS CIRCUITOS ELÉCTRICOS.</li>
                                        </ul>
                                        <h4>Módulo VII:</h4>
                                        <ul>
                                            <li class="chevron">PRACTICA I.</li>
                                        </ul>
                                        <h4>Módulo VIII:</h4>
                                        <ul>
                                            <li class="chevron">PRACTICA II.</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane" id="comments">
                                    <div class="tab-pane active" id="overview"><br>
                                        ...
                                        <div class="card-body" id="course_content">
                                            ...
                                            <a href='https://drive.google.com/drive/folders/19b8TdyOIs3rOGEe03TZ9xUqInzYTj7wj?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                            
                                            <strong>ELECTRICIDAD BASICA </strong><br>
                                            <a href='https://docs.google.com/presentation/d/1Dn4afQ-ZnYnBpdardXnOZWx46UlNQSV_/edit?usp=sharing&ouid=109538134094239867146&rtpof=true&sd=true' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                            
                                            <strong>Material de electricidad basica </strong><br>
                                            <a href='https://drive.google.com/file/d/1R0wHJbBiA9_38nVw0CuhsQQtgRW-K5hB/view?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                            
                                            <strong>pdf-analisis-de-circuitos-electricos-ii-ing-jimenez_compress </strong><br>
                                            <a href='https://drive.google.com/file/d/1-ZWFfgXDn77iMxaQXQkbdAPoBp7op20B/view?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                            
                                            <strong>sistema_carga_libroalumno_unidad1muestra </strong><br>
                                            <a href='https://drive.google.com/file/d/1Oco3v65g0cFKD7mZdMTzQu7h5pzz3VR8/view?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
