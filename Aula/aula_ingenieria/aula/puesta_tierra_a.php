...
?>
        ...
        <div class="mdk-header-layout__content page">
                ...
                <div class="row" style="height: auto;">
                    <div class="col-md-12">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 mb-4" style="max-height:auto; background: #000;">
                            <iframe id="player1" class="embed-responsive-item" src="https://www.youtube.com/embed/1BhgmFV3pEM" allowfullscreen=""></iframe>
                        </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid1" onclick="changeVid(this.id)">SISTEMA PUESTA TIERRA</a>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid2" onclick="changeVid(this.id)">SISTEMA PUESTA TIERRA</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
            ...
            <script type="text/javascript">
                ...
                {   
                    var newVid = "https://www.youtube.com/embed/1BhgmFV3pEM";
                    if (clicked_id === 'vid1') {
                        newVid = 'https://www.youtube.com/embed/1BhgmFV3pEM';
                    }
                    if (clicked_id === 'vid2') {
                        newVid = 'https://www.youtube.com/embed/IrVfUY2NQF0';
                    }
                    if (clicked_id === 'vid3') {
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="comments">
                                    <div class="tab-pane active" id="overview"><br>
                                        ...
                                        <div class="card-body" id="course_content">
                                            <a href='https://drive.google.com/uc?export=download&id=1sgZHh4wt0NXoczrtC9BQfMQ7UKuyGHMs' target='_blank'><button type='button' class='btn btn-success'>Modulo 1-Sistemas-de-puesta-tierra-FD-1</button></a>
                                        </div>
                                    </div>
                                </div>
