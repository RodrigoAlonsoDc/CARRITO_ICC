...
?>
        ...
        <div class="mdk-header-layout__content page" >
                ...
                <div class="row" style="height: auto;">
                    <div class="col-md-12">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 mb-4" style="max-height:auto; background: #000;">
                            <iframe id="player1" class="embed-responsive-item" src="https://www.youtube.com/embed/_dweFcQm2RQ" allowfullscreen=""></iframe>
                        </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid1" onclick="changeVid(this.id)">CAPITULO 1</a>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid2" onclick="changeVid(this.id)">CAPITULO 2</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid3" onclick="changeVid(this.id)">CAPITULO 3</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid4" onclick="changeVid(this.id)">CAPITULO 4 TEMA 1</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid5" onclick="changeVid(this.id)">TEMA 2</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid6" onclick="changeVid(this.id)">SOFTWARE DE SIMULACION 1</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid7" onclick="changeVid(this.id)">PARTE PRACTICA MODULO 1</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid8" onclick="changeVid(this.id)">PARTE PRACTICA 2 MODULO 1</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid9" onclick="changeVid(this.id)">MARCO TEORICO</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid10" onclick="changeVid(this.id)">COMPONENTE PRINICIPAL Y ARRANQUE ESTRELLA TRIANGULO</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid11" onclick="changeVid(this.id)">SOFTWARE DE SIMULACION 2</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid12" onclick="changeVid(this.id)">VARIADORES DE VELOCIDAD DIAPO 30 TEMA 1</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid13" onclick="changeVid(this.id)">TIPOS DE VARIADORES</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
            ...
            <script type="text/javascript">
                ...
                {   
                    var newVid = "https://www.youtube.com/embed/_dweFcQm2RQ";
                    if (clicked_id === 'vid1') {
                        newVid = 'https://www.youtube.com/embed/_dweFcQm2RQ';
                    }
                    if (clicked_id === 'vid2') {
                        newVid = 'https://www.youtube.com/embed/oTFYo-J7gYY';
                    }
                    if (clicked_id === 'vid3') {
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="comments">
                                    <div class="tab-pane active" id="overview"><br>
                                        ...
                                        <div class="card-body" id="course_content">
                                            <a href='https://drive.google.com/uc?export=download&id=1BFKxUbclI_sZFt_J7NLiuG0F-o0rw0fc' target='_blank'><button type='button' class='btn btn-success'>MODULO 1 </button></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane active" id="overview">
                                        <div class="card-body" id="course_content">
                                            <a href='https://drive.google.com/uc?export=download&id=1Ce5bxiehVLEAptqW0UdV8lZmRduyVdoX' target='_blank'><button type='button' class='btn btn-success'>MODULO 2</button></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane active" id="overview">
                                        <div class="card-body" id="course_content">
                                            <a href='https://drive.google.com/uc?export=download&id=1E5SHbmMyXHBxmS9ZUb_WhsMiaOOHb8NM' target='_blank'><button type='button' class='btn btn-success'>MODULO 3</button></a>
                                        </div>
                                    </div>
                                </div>
