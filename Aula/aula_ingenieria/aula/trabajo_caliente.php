...
?>
        ...
        <div class="mdk-header-layout__content page" >
                ...
                <div class="row" style="height: auto;">
                    <div class="col-md-12">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 mb-4" style="max-height:auto; background: #000;">
                            <iframe id="player1" class="embed-responsive-item" src="https://www.youtube.com/embed/aTo1EAN21PM" allowfullscreen=""></iframe>
                        </div>
                            ...
                            <div class="card clear-shadow border">
                                <div class="card-body ">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <strong>Trabajo en caliente </strong>
                                        <small class="text-muted">25min</small>
                                    </div>
                                    <div>
                                        <span class="mr-2">
                                  ...
                                  <div class="">
                                    <div class="tabs">
                                        <div class="tab">
                                            ...
                                            <label class="tab-label" style="width: 100%; margin-bottom: 1px;" for="chck1">M&oacute;dulo 1</label>
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid1" onclick="changeVid(this.id)">TRABAJO EN CALIENTE</a>
                                                    </div>
            ...
            <script type="text/javascript">
                ...
                {   
                    var newVid = "https://www.youtube.com/embed/aTo1EAN21PM";
                    if (clicked_id === 'vid1') {
                        newVid = 'https://www.youtube.com/embed/aTo1EAN21PM';
                    }
                    if (clicked_id === 'vid2') {
                        newVid = 'https://www.youtube.com/embed/0TM0VpTiLRg';
                    }
                    if (clicked_id === 'vid3') {
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card">
                            ...
                            <div class="tab-content">
                                ...
                                <!--        <div class="card-body" id="course_content">-->
                                <!--            <a href='https://drive.google.com/uc?export=download&id=1yB_Wqpk0J42UrXej5oSjIKlTlMT0CwcR' target='_blank'><button type='button' class='btn btn-success'>Capa trabajo altura</button></a>-->
                                <!--        </div>-->
                                <!--    </div>-->
                                <!--</div>-->
                        ...
                        <div class="card">
                            <div class="card-header card-header-large bg-light d-flex align-items-center">
                                <div class="flex">
                                    ...
                                    <div class="card-subtitle text-muted">Progreso actual de la sesi&oacute;n</div>
                                </div>
                                <div class="ml-auto">
