...
?>
        ...
        <div class="mdk-header-layout__content page" >
                ...
                <div class="row" style="height: auto;">
                    <div class="col-md-12">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 mb-4" style="max-height:auto; background: #000;">
                            <iframe id="player1" class="embed-responsive-item" src="https://www.youtube.com/embed/MfoBZmD7-Oc" allowfullscreen=""></iframe>
                        </div>
                            ...
                            <div class="card clear-shadow border">
                                <div class="card-body ">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <strong>Banco de condensadores </strong>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid1" onclick="changeVid(this.id)">Banco de Condensadores I</a>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid2" onclick="changeVid(this.id)">Banco de Condensadores II</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
            ...
            <script type="text/javascript">
                ...
                {   
                    var newVid = "https://www.youtube.com/embed/MfoBZmD7-Oc";
                    if (clicked_id === 'vid1') {
                        newVid = 'https://www.youtube.com/embed/MfoBZmD7-Oc';
                    }
                    if (clicked_id === 'vid2') {
                        newVid = 'https://www.youtube.com/embed/9ResyD5l2OA';
                    }
                    if (clicked_id === 'vid3') {
                        newVid = 'https://www.youtube.com/embed/dGflIhD9vuM';
                    }
                    if (clicked_id === 'vid4') {
                        newVid = 'https://www.youtube.com/embed/Py_z8gbvgOo';
                    }
                    if (clicked_id === 'vid5') {
                        newVid = 'https://www.youtube.com/embed/p8Y4ZDzhNRw';
                    }
                    if (clicked_id === 'vid6') {
                        newVid = 'https://www.youtube.com/embed/CSsVjZ8VwdQ';
                    }
                    if (clicked_id === 'vid7') {
                        newVid = 'https://www.youtube.com/embed/wlX1JvjiPLw';
                    }
                    if (clicked_id === 'vid8') {
                        newVid = 'https://www.youtube.com/embed/pFjC4WuG0AM';
                    }
                    if (clicked_id === 'vid9') {
                        newVid = 'https://www.youtube.com/embed/C4f26wXUT84';
                    }
                    if (clicked_id === 'vid10') {
                        newVid = 'https://www.youtube.com/embed/_AVT1i3IIaY';
                    }
                    if (clicked_id === 'vid11') {
                        newVid = 'https://www.youtube.com/embed/CSsVjZ8VwdQ';
                    }
                    if (clicked_id === 'vid12') {
                        newVid = 'https://www.youtube.com/embed/AVqgB_G1Sps';
                    }
                    if (clicked_id === 'vid13') {
                        newVid = 'https://www.youtube.com/embed/MtwlcgyQDn4';
                    }
                    if (clicked_id === 'vid14') {
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="overview">
                                    <div class="card-body" id="course_content">
                                        ...
                                        <p>Los participantes aprender&aacuten las ventajas de la compensaci&oacuten del factor potencia, asi como las tecnolog&iacuteas dentro de los bancos de capacitores, conocer&aacuten, adem&aacutes, las corrientes arm&oacutenicas su tipo de medici&oacuten y los filtros activos y pasivos mas all&aacute de su filtrador.<p/>
                                        <!--<ul>-->
                                        <!--    <li class="chevron"></li>-->
                                        <!--    <li class="chevron"></li>-->
                                        <!--    <li class="chevron"></li>-->
                                        ...
                                        <h4>Dirigido a</h4>
                                        <p>T&eacutecnicos, supervisores e ingenieros de la rama de electricidad y p&uacuteblico en general, los cuales aprender&aacuten con la teor&iacutea y aplicaciones pr&aacutecticas que se encontrar&aacuten en trabajos de campo.<p/>
                                        <!--<ul>-->
                                        <!--    <li class="confirm"></li>-->
                                        <!--    <li class="confirm"></li>-->
                                        <!--    <li class="confirm"></li>-->
                                        ...
                                        <h4>MODULO 1</h4>
                                        <ul>
                                            <li class="chevron">Te&oacuterica</li>
                                        </ul>
                                        <h4>MODULO 2</h4>
                                        <ul>
                                            <li class="chevron">Por qu&eacute compensar la reactiva?</li>
                                        </ul>
                                        <h4>MODULO 3</h4>
                                        <ul>
                                            <li class="chevron">La reactiva</li>
                                        </ul>
                                        <h4>MODULO 4</h4>
                                        <ul>
                                            <li class="chevron">Ventajas de la compensaci&oacuten del factor potencia</li>
                                        </ul>
                                        <h4>MODULO 5</h4>
                                        <ul>
                                            <li class="chevron">C&oacutemo dimensionar un banco de capacitores?</li>
                                        </ul>
                                        <h4>MODULO 6</h4>
                                        <ul>
                                            <li class="chevron">Tecnolog&iacutea dentro de los bancos de capacitores</li>
                                        </ul>
                                        <h4>MODULO 7</h4>
                                        <ul>
                                            <li class="chevron">Corrientes arm&oacutenicas</li>
                                        </ul>
                                        <h4>MODULO 8</h4>
                                        <ul>
                                            <li class="chevron">Generadores de arm&oacutenicas</li>
                                        </ul>
                                        <h4>MODULO 9</h4>
                                        <ul>
                                            <li class="chevron">Efectos de arm&oacutenicas</li>
                                        </ul>
                                        <h4>MODULO 10</h4>
                                        <ul>
                                            <li class="chevron">Mediciones arm&oacutenicas</li>
                                        </ul>
                                        <h4>MODULO 11</h4>
                                        <ul>
                                            <li class="chevron">Tipos de filtros</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane" id="comments">
                                    <div class="tab-pane active" id="overview"><br>
                                        ...
                                        <div class="card-body" id="course_content">
                                            <strong>Presentaci&oacuten Banco de Condensadores </strong><br>
                                            <a href='https://drive.google.com/file/d/1BY4l2EQhlBnEWMqXQJcqkoshdZl_Chbg/view?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                            
                                            <strong>pdf-banco-de-condensadores_compress </strong><br>
                                            <a href='https://drive.google.com/file/d/1aRm6QPLUCPpqyGLCDRwb9mqwS97U27Om/view?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                            
                                            <strong>Material de  Trabajo Banco de condensadores </strong><br>
                                            <a href='https://drive.google.com/file/d/1_8nnGyFq94AUNQCye-92szGAvB-5BwjB/view?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                            
                                            <strong>E-SE-009_R-04 </strong><br>
                                            <a href='https://drive.google.com/file/d/1fVWt4YAtZ3qAZCafEkbMUw6FV5qFb_zc/view?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                            
                                            <strong>Articulo_4 </strong><br>
                                            <a href='https://drive.google.com/file/d/1UAuTPaLAHMt2pr7HXmwO4fa83Vu38OXk/view?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                            
                                            <strong>LIBROS </strong><br>
                                            <a href='https://drive.google.com/drive/folders/1z_iCEEr79zDiP8OuMB-tyYAOMvHowQg1?usp=sharing' target='_blank'><button type='button' class='btn btn-success'>Descargar</button></a><br><br>
                                        </div>
                                    </div>
                                </div>
