...
?>
        ...
        <div class="mdk-header-layout__content page" >
                ...
                <div class="row" style="height: auto;">
                    <div class="col-md-12">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 mb-4" style="max-height:auto; background: #000;">
                            <iframe id="player1" class="embed-responsive-item" src="https://www.youtube.com/embed/PDPdRBW7Z9w" allowfullscreen=""></iframe>
                        </div>
                                    ...
                                    <div class="tabs">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid1" onclick="changeVid(this.id)">Introducción a la seguridad con la electricidad</a>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid2" onclick="changeVid(this.id)">Los riesgos en instalaciones y servicios con electricidad</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid3" onclick="changeVid(this.id)">Choque electrico mecanismos y efectos</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid4" onclick="changeVid(this.id)">Los arcos eléctricos, causas y efectos</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid5" onclick="changeVid(this.id)">Los campos electromagnéticos</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid6" onclick="changeVid(this.id)">Técnicas de análisis de riesgos</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1. a)</div>
                                                    </div>
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid7" onclick="changeVid(this.id)">Medidas de control para el riesgo eléctrico: desenergización</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1. b)</div>
                                                    </div>
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid8" onclick="changeVid(this.id)">Puesta a tierra funcional</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1. c)</div>
                                                    </div>
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid9" onclick="changeVid(this.id)">Equipotencialización</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1. d)</div>
                                                    </div>
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid10" onclick="changeVid(this.id)">Seccionamiento automatico de la alimentación</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1. e)</div>
                                                    </div>
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid11" onclick="changeVid(this.id)">Dispositivos de corriente de fuga</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1. f)</div>
                                                    </div>
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid12" onclick="changeVid(this.id)">Extra baja tensión</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1. g)</div>
                                                    </div>
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid13" onclick="changeVid(this.id)">Las barreras y envolventes</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1. h)</div>
                                                    </div>
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid14" onclick="changeVid(this.id)">Los bloqueos e impedimentos</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1. i)</div>
                                                    </div>
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid15" onclick="changeVid(this.id)">Obstaculos y escudos</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1. j)</div>
                                                    </div>
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid16" onclick="changeVid(this.id)">Aislamiento de las partes activas</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1. k)</div>
                                                    </div>
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid17" onclick="changeVid(this.id)">Aislamiento doble o reforzado</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1. l)</div>
                                                    </div>
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid18" onclick="changeVid(this.id)">Colocación fuera de alcance</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1. m)</div>
                                                    </div>
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid19" onclick="changeVid(this.id)">Separación eléctrica de alimentadores</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid20" onclick="changeVid(this.id)">Normaitva internacional y nacional</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid21" onclick="changeVid(this.id)">Equipo de protección colectiva</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid22" onclick="changeVid(this.id)">Equipo de protección personal</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid23" onclick="changeVid(this.id)">Rutinas de trabajo - Procedimientos: instalaciones desenergizadas</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid24" onclick="changeVid(this.id)">Autorización para el servicio y liberación</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid25" onclick="changeVid(this.id)">Señalización</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <label class="tab-label" style="width: 100%; margin-bottom: 1px;" for="chck11">Módulo 11</label>
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1.</div>
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid26" onclick="changeVid(this.id)">Documentación de las instalaciones eléctricas</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <label class="tab-label" style="width: 100%; margin-bottom: 1px;" for="chck12">Módulo 12</label>
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1.</div>
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid27" onclick="changeVid(this.id)">Riesgos adicionales y protección y combate de incendios</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <label class="tab-label" style="width: 100%; margin-bottom: 1px;" for="chck13">Módulo 13</label>
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1.</div>
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid28" onclick="changeVid(this.id)">Accidentes de origen eléctrico</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <label class="tab-label" style="width: 100%; margin-bottom: 1px;" for="chck14">Módulo 14</label>
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1.</div>
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid29" onclick="changeVid(this.id)">Primeros auxilios</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <label class="tab-label" style="width: 100%; margin-bottom: 1px;" for="chck15">Módulo 15</label>
                                            <div class="tab-content1">
                                                <div class="media">
                                                    <div class="media-left mr-1">
                                                        <div class="text-muted">1.</div>
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid30" onclick="changeVid(this.id)">Responsabilidades</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
            ...
            <script type="text/javascript">
                ...
                {   
                    var newVid = "https://www.youtube.com/embed/PDPdRBW7Z9w";
                    if (clicked_id === 'vid1') {
                        newVid = 'https://www.youtube.com/embed/PDPdRBW7Z9w';
                    }
                    if (clicked_id === 'vid2') {
                        newVid = 'https://www.youtube.com/embed/V3TEXWy0fpc';
                    }
                    if (clicked_id === 'vid3') {
                        newVid = 'https://www.youtube.com/embed/hVoOgUPamTk';
                    }
                    if (clicked_id === 'vid4') {
                        newVid = 'https://www.youtube.com/embed/G2Ank67T768';
                    }
                    if (clicked_id === 'vid5') {
                        newVid = 'https://www.youtube.com/embed/eM7Y5FvA-6s';
                    }
                    if (clicked_id === 'vid6') {
                        newVid = 'https://www.youtube.com/embed/o2Ld1ZaCKvk';
                    }
                    if (clicked_id === 'vid7') {
                        newVid = 'https://www.youtube.com/embed/0N2GbmOjEqg';
                    }
                    if (clicked_id === 'vid8') {
                        newVid = 'https://www.youtube.com/embed/ECBBaLY2Dpw';
                    }
                    if (clicked_id === 'vid9') {
                        newVid = 'https://www.youtube.com/embed/Hwh5ucAy_9M';
                    }
                    if (clicked_id === 'vid10') {
                        newVid = 'https://www.youtube.com/embed/zSjhlr0terY';
                    }
                    if (clicked_id === 'vid11') {
                        newVid = 'https://www.youtube.com/embed/Unz38idlDFU';
                    }
                    if (clicked_id === 'vid12') {
                        newVid = 'https://www.youtube.com/embed/hG23riIvb3I';
                    }
                    if (clicked_id === 'vid13') {
                        newVid = 'https://www.youtube.com/embed/ekgPrmFoB38';
                    }
                    if (clicked_id === 'vid14') {
                        newVid = 'https://www.youtube.com/embed/eQ1gmNqeO-o';
                    }
                    if (clicked_id === 'vid15') {
                        newVid = 'https://www.youtube.com/embed/KZvk6OnLCP0';
                    }
                    if (clicked_id === 'vid16') {
                        newVid = 'https://www.youtube.com/embed/p7ow4R8MFs8';
                    }
                    if (clicked_id === 'vid17') {
                        newVid = 'https://www.youtube.com/embed/6p-6x3bhbhM';
                    }
                    if (clicked_id === 'vid18') {
                        newVid = 'https://www.youtube.com/embed/sT9ljAYLpKs';
                    }
                    if (clicked_id === 'vid19') {
                        newVid = 'https://www.youtube.com/embed/CIEkr0XoDIs';
                    }
                    if (clicked_id === 'vid20') {
                        newVid = 'https://www.youtube.com/embed/YrhL4Us291I';
                    }
                    if (clicked_id === 'vid21') {
                        newVid = 'https://www.youtube.com/embed/DitI-30VgGg';
                    }
                    if (clicked_id === 'vid22') {
                        newVid = 'https://www.youtube.com/embed/slB7wt57nj8';
                    }
                    if (clicked_id === 'vid23') {
                        newVid = 'https://www.youtube.com/embed/WtcOJNg1To8';
                    }
                    if (clicked_id === 'vid24') {
                        newVid = 'https://www.youtube.com/embed/p6zRyCLzUbU';
                    }
                    if (clicked_id === 'vid25') {
                        newVid = 'https://www.youtube.com/embed/dCLDQCe5bxI';
                    }
                    if (clicked_id === 'vid26') {
                        newVid = 'https://www.youtube.com/embed/-KguN3V4C68';
                    }
                    if (clicked_id === 'vid27') {
                        newVid = 'https://www.youtube.com/embed/x9H78eoDx0E';
                    }
                    if (clicked_id === 'vid28') {
                        newVid = 'https://www.youtube.com/embed/riCRasMwngg';
                    }
                    if (clicked_id === 'vid29') {
                        newVid = 'https://www.youtube.com/embed/USEcVYrNQAQ';
                    }
                    if (clicked_id === 'vid30') {
                        newVid = 'https://www.youtube.com/embed/xua7NwXgQXM';
                    }
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="card">
                            ...
                            <!--            <div class="card-body" id="course_content">-->
                            <!--                <a href='https://drive.google.com/uc?export=download&id=1quyUbEu26y8H-UQ9YAFvga103Ug8DBvk' target='_blank'><button type='button' class='btn btn-success'>Cap.Seguridad Electrica.</button></a>-->
                            <!--            </div>-->
                            <!--        </div>-->
                            <!--    </div>-->
