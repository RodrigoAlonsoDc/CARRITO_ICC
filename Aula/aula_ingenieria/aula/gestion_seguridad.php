...
?>
        ...
        <div class="mdk-header-layout__content page">
                ...
                <div class="row" style="height: auto;">
                    <div class="col-md-12">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 mb-4" style="max-height:auto; background: #000;">
                            <iframe id="player1" class="embed-responsive-item" src="https://www.youtube.com/embed/EFv9-P8cUq4" allowfullscreen=""></iframe>
                        </div>
                            ...
                            <div class="card clear-shadow border">
                                <div class="card-body ">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <strong>Gestión y seguridad en el trabajo ley N°29783 </strong>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid1" onclick="changeVid(this.id)">>Gestión y seguridad en el trabajo ley N°29783</a>
                                                    </div>
            ...
            <script type="text/javascript">
                ...
                {   
                    var newVid = "https://www.youtube.com/embed/EFv9-P8cUq4";
                    if (clicked_id === 'vid1') {
                        newVid = 'https://www.youtube.com/embed/EFv9-P8cUq4';
                    }
                    if (clicked_id === 'vid2') {
                        newVid = 'https://www.youtube.com/embed/D8t_L3Vlt-4';
                    }
                    if (clicked_id === 'vid3') {
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="card">
                            ...
                            <!--            <div class="card-body" id="course_content">-->
                            <!--                <a href='https://drive.google.com/uc?export=download&id=1OmWqiGFIJka5vCyJXEa8QOV-XdZ0vjO6' target='_blank'><button type='button' class='btn btn-success'>Sistema de Gestion SST-ICC</button></a>-->
                            <!--            </div>-->
                            <!--        </div>-->
                            <!--    </div>-->
