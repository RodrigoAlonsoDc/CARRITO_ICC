...
?>
        ...
        <div class="mdk-header-layout__content page" >
                ...
                <div class="row" style="height: auto;">
                    <div class="col-md-12">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 mb-4" style="max-height:auto; background: #000;">
                            <iframe id="player1" class="embed-responsive-item" src="https://www.youtube.com/embed/7k3fI_2zRQ4" allowfullscreen=""></iframe>
                        </div>
                            ...
                            <div class="card clear-shadow border">
                                <div class="card-body ">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <strong>Especialización de motores eléctricos trifásicos </strong>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid1" onclick="changeVid(this.id)">Arranque Directo – Inversión de Giro</a>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid2" onclick="changeVid(this.id)">Arranque Directo – Inversión de Giro 2</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid3" onclick="changeVid(this.id)">Arranque de Motores con Contactores/Arranque Estrella – Triángulo</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid4" onclick="changeVid(this.id)">Arranque de Motores con Contactores/Arranque Estrella – Triángulo 2</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid5" onclick="changeVid(this.id)">Arranque de Motores Eléctricos Mediante Variadores de Velocidad</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
            ...
            <script type="text/javascript">
                ...
                {   
                    var newVid = "https://www.youtube.com/embed/7k3fI_2zRQ4";
                    if (clicked_id === 'vid1') {
                        newVid = 'https://www.youtube.com/embed/7k3fI_2zRQ4';
                    }
                    if (clicked_id === 'vid2') {
                        newVid = 'https://www.youtube.com/embed/CSsVjZ8VwdQ';
                    }
                    if (clicked_id === 'vid3') {
                        newVid = 'https://www.youtube.com/embed/_eT5x5MRusY';
                    }
                    if (clicked_id === 'vid4') {
                        newVid = 'https://www.youtube.com/embed/xrzs7DiIchc';
                    }
                    if (clicked_id === 'vid5') {
                        newVid = 'https://www.youtube.com/embed/Z64Mcz0i9sg';
                    }
                    if (clicked_id === 'vid6') {
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="comments">
                                    <div class="tab-pane active" id="overview"><br>
                                        ...
                                        <div class="card-body" id="course_content">
                                            <a href='https://drive.google.com/uc?export=download&id=1O26hOTLGv_viY7RI-G5P5Rd1SaUttiMl' target='_blank'><button type='button' class='btn btn-success'>MODULO-1-ARRANQUE-DE-MOTORES</button></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane active" id="overview">
                                        <div class="card-body" id="course_content">
                                            <a href='https://drive.google.com/uc?export=download&id=1bVrm_G2HtuR7ew9urS_9x5FIGMcJD0dN' target='_blank'><button type='button' class='btn btn-success'>MODULO-2-ARRANQUE-DE-MOTORES</button></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane active" id="overview">
                                        <div class="card-body" id="course_content">
                                            <a href='https://drive.google.com/uc?export=download&id=1d21iTJ8YOW6pj6JIXGc5E3Cz3OoQ7mDH' target='_blank'><button type='button' class='btn btn-success'>Modulo 3</button></a>
                                        </div>
                                    </div>
                                </div>
