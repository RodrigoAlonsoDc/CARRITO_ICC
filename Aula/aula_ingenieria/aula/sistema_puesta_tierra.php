...
?>
        ...
        <div class="mdk-header-layout__content page">
                ...
                <div class="row" style="height: auto;">
                    <div class="col-md-12">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 mb-4" style="max-height:auto; background: #000;">
                            <iframe id="player1" class="embed-responsive-item" src="https://www.youtube.com/embed/C7_9J8mm3K8" allowfullscreen=""></iframe>
                        </div>
                            ...
                            <div class="card clear-shadow border">
                                <div class="card-body ">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <strong>Sistema puesto a tierra </strong>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid1" onclick="changeVid(this.id)">GENERALIDADES DE SISTEMA PUESTA A TIERRA</a>
                                                    </div>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid2" onclick="changeVid(this.id)">RESISTIVIDAD DE TERRENO Y RESISTENCIA DE SISTEMA PUESTA A TIERRA</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid3" onclick="changeVid(this.id)">ELECTRODOS DE PUESTA A TIERRA Y CONFIGURACIÓN</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid4" onclick="changeVid(this.id)">PRACTICA</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
            ...
            <script type="text/javascript">
                ...
                {   
                    var newVid = "https://www.youtube.com/embed/C7_9J8mm3K8";
                    if (clicked_id === 'vid1') {
                        newVid = 'https://www.youtube.com/embed/C7_9J8mm3K8';
                    }
                    if (clicked_id === 'vid2') {
                        newVid = 'https://www.youtube.com/embed/7klKIRAUXzA';
                    }
                    if (clicked_id === 'vid3') {
                        newVid = 'https://www.youtube.com/embed/pnUXTn8uDb4';
                    }
                    if (clicked_id === 'vid4') {
                        newVid = 'https://www.youtube.com/embed/XU7nS4lEEWk';
                    }
                    if (clicked_id === 'vid5') {
...
óptimas de funcionamiento y conservación medioambiental.<p/>
                                        ...
                                        <h4>Módulo I:</h4>
                                        <ul>
                                            <li class="chevron">GENERALIDADES DE SISTEMA PUESTA A TIERRA</li>
                                        </ul>
                                        <h4>Módulo II:</h4>
                                        <ul>
                                            <li class="chevron">RESISTIVIDAD DE TERRENO Y RESISTENCIA DE SISTEMA PUESTA A TIERRA</li>
                                            <li class="chevron">ELECTRODOS DE PUESTA A TIERRA Y CONFIGURACIÓN</li>
                                            <li class="chevron">PRACTICA</li>
                                    </div>
                                </div>
